...
train <- read.csv('E:\\R Code files\\R Data Sets\\Titanic\\train.csv', stringsAsFactors = F)
test  <- read.csv('E:\\R Code files\\R Data Sets\\Titanic\\test.csv', stringsAsFactors = F)
